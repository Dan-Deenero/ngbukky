...
class SpareAddWalletPage extends ConsumerStatefulWidget {
  const SpareAddWalletPage({super.key});

  @override
  ConsumerState<SpareAddWalletPage> createState() => _SpareAddWalletPageState();
}

class _SpareAddWalletPageState extends ConsumerState<SpareAddWalletPage> {
