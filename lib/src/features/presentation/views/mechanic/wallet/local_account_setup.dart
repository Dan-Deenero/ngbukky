...
class LocalAccountSetup extends ConsumerStatefulWidget {
  const LocalAccountSetup({super.key});

  @override
  ConsumerState<LocalAccountSetup> createState() => _LocalAccountSetupState();
}

class _LocalAccountSetupState extends ConsumerState<LocalAccountSetup> {
  ...
  saveAccount() async {
    ...
    if (result) {
      locator<LocalStorageService>()
          .saveDataToDisk(AppKeys.accountNo, accountNumber.text);
      showSuccesModal();
      password.clear();
      accountNumber.clear();
